# coding-challenges
this repo is ment for each and everyone that is joining us as a full time developer either part time or full time as our coding challenges and interviews 
# Backend Challenge
...
- Push your code to a **Github private repository** and add @https://github.com/synetoss9 as a collaborator for it.
  This Github account (@ze-engineering-code-challenge) is solely used by Synetoss engineers to download your code and review it.
